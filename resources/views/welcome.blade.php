              ...
              <div class="card mb-3">
                ...
                <div class="card-body">
                    @if (session('loginError'))
                        <div class="mt-4 ms-3 me-3 alert alert-danger alert-dismissible fade show" role="alert">
                  ...
                  <form class="row g-3 needs-validation" action="/logins" method="POST">
                    ...
                    <div class="col-12">
                      <p class="small mb-0">Tidak Mempunyai Akun ? <a href="/register">Register</a></p>
                    </div>
                  </form>
